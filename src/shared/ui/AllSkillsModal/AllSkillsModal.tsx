...
export const AllSkillsModal = forwardRef<HTMLDivElement, AllSkillsModalProps>(
  ({ isOpen }, ref) => {
    ...
    return createPortal(
      <div
        ...
        className={styles['skills__modal-container']}
      >
...
AllSkillsModal.displayName = 'AllSkillsModal';
