...
`ProfileFavoritesPage/`: Страница избранных карточек пользователя.

`LoginPage/`: Страница авторизации.

`RegisterPage/`: Страница регистрации.

`CardDetailPage/`: Страница детального просмотра навыка.
...
`ActionBar/`: Экшн-бар с кнопками.

`Filters/`: Блоки с фильтрами на главной странице.

`FiltersPanel/`: Полная панель фильтров на главной странице.

`Card/`: Компонент карточки.

`CardDetail/`: Компонент детального вида карточки.

`CardsFeed/`: Лента с карточками пользователей.

`ProfileMenu/`: Меню профиля пользователя.
...
`favorites/`: Логика работы с лайками.

`drag-and-drop/`: Логика работы drab and drop.
